...
import com.miragemock.admin.alert.AlertProperties;
 ...
 */
@Configuration
@EnableConfigurationProperties({ SecurityProperties.class, TestTargetProperties.class, AlertProperties.class })
